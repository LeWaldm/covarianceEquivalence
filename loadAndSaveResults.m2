...
saveResults = (fileName,env,variancePartition,dags,groups) -> (
    
    -- parse variancePartition
    nodes := env_0;
    ...
    if fileExists(fileName) then (
        ...
        -- save identicalVanishingIdealGroups
...
loadResults = (fileName) -> (
    ...
    dags = loadPPrintList(fileLines,"dags");
    (env,allVariancePartitions,allIdenticalVanishingIdealGroups,dags)
);
